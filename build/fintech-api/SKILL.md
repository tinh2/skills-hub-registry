---
name: fintech-api
description: Scaffold a production-ready financial services API with Plaid integration, payment processing, double-entry ledger, KYC workflow, and audit logging.
version: "1.0.0"
category: build
platforms:
  - CLAUDE_CODE
...
and produce a complete, production-ready backend with payment processing, ledger
system, KYC workflow, and comprehensive audit logging.
