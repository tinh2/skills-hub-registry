...
Builds fast, then the safety net catches everything before production.

Run the entire pipeline autonomously.
...
============================================================
PHASE 2: BUILD IT (60% of time budget)
============================================================

Build the feature with maximum velocity.
...
The build is done. Now make sure it doesn't blow up in production.
