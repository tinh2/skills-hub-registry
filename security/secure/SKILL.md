---
name: secure
description: Comprehensive security posture scan — dependencies, code patterns, config, auth, and data handling with risk scoring.
version: "1.0.0"
category: security
platforms:
  - CLAUDE_CODE
...
If no arguments provided, perform a full security posture assessment of the project
