...
description: Defense maintenance analysis covering MRO optimization, readiness reporting, reliability-centered maintenance, configuration management, and depot-level analytics per MIL-STD and condition-based maintenance frameworks
version: "1.0.0"
category: analysis
platforms:
  - CLAUDE_CODE
...
Identify the maintenance and logistics infrastructure:
...
Analyze weapon system readiness and availability:

Step 2.1 -- Readiness Metrics Calculation

Calculate key readiness indicators:
- **Mission Capable (MC) Rate**: % of time platform is capable of performing at least one assigned mission
...
- **Not Mission Capable (NMC) Rate**: further broken down:
...
============================================================
PHASE 3: RELIABILITY-CENTERED MAINTENANCE (RCM) ANALYSIS
============================================================
...
- Age-reliability relationship: which components actually benefit from time-based replacement?
...
Step 3.3 -- Condition-Based Maintenance (CBM+) Assessment
...
Optimize maintenance resources (personnel, parts, tools, facilities):
...
Step 4.2 -- Parts and Supply Chain Optimization
...
Evaluate configuration management and modification tracking:
...
============================================================
PHASE 6: REPORT AND READINESS IMPROVEMENT PLAN
============================================================

Write the complete analysis to `docs/defense-maintenance-analysis.md`.

Step 6.1 -- Readiness Improvement Roadmap
...
Step 6.2 -- Resource Requirements

Estimate resources needed for each improvement:
- Personnel (military, civilian, contractor)
- Funding (O&M, procurement, RDT&E)
