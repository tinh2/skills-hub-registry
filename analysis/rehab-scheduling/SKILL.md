...
description: Analyzes rehabilitation scheduling optimization systems for therapist utilization, patient flow management, equipment allocation, insurance authorization tracking, and session spacing per CMS therapy caps, CPT code scheduling rules, and payer requirements.
version: "1.0.0"
category: analysis
platforms:
  - CLAUDE_CODE
