...
If arguments are provided, use them to focus the analysis (e.g., specific product categories, pricing channels, or competitive segments). If no arguments, scan the current project for pricing engines, competitive intelligence feeds, and elasticity models.
...
Map the pricing infrastructure:
...
Catalog competitive data sources:
...
Evaluate elasticity models:
- Elasticity estimation methodology: regression, ML, A/B testing, conjoint analysis
...
- KVI (Known Value Item) identification methodology
...
- Promotion types: TPR (temporary price reduction), BOGO, bundled, loyalty-exclusive
