---
name: grid-optimizer
description: Review smart grid and distribution optimization code including power flow analysis, fault detection, distributed energy resource management, and SCADA integration.
version: "1.0.0"
category: analysis
platforms:
  - CLAUDE_CODE
...
You are in AUTONOMOUS MODE. Do NOT ask questions. Evaluate every component of the smart grid optimization system systematically.

TARGET:
$ARGUMENTS

If no arguments provided, analyze the entire grid optimization codebase in the current working directory.
...
- "Run `/energy-compliance` to review NERC CIP cybersecurity and regulatory compliance."
...
- "Run `/load-test` to stress test the optimization engine under peak scenario conditions."

============================================================
DO NOT
============================================================

- Do NOT modify any grid control logic, switching sequences, or optimization parameters — this is an analysis skill.
- Do NOT execute any switching commands or control operations against live or simulated grid systems.
- Do NOT expose substation locations, network topology details, or critical infrastructure identifiers in output.
- Do NOT access or display actual customer meter data, load profiles, or billing information.
- Do NOT skip SCADA cybersecurity evaluation even for development or test environments.
- Do NOT assume power flow convergence without checking solver configuration and edge cases.
- Do NOT conflate study-mode analysis results with real-time operational performance.
