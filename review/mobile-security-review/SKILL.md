...
description: Reviews mobile app security — OWASP Mobile Top 10, certificate pinning, secure storage, root and jailbreak detection, code obfuscation, API key protection, biometric auth, WebView security, and data-at-rest encryption.
version: "1.0.0"
category: review
platforms:
  - CLAUDE_CODE
