...
description: Database schema design review. Checks normalization, index coverage, constraint completeness, naming conventions, data types, N+1 patterns, connection pooling, and migration safety.
version: "1.0.0"
category: review
platforms:
  - CLAUDE_CODE
