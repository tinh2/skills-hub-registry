...
description: "Review database schema design, query patterns, and data access layer for correctness and performance. Triggers: you need to review a database schema, find missing indexes, detect N+1 queries, audit data types."
version: "2.0.1"
category: review
platforms:
  - CLAUDE_CODE
